...
def main():
    ...
    base_model_config = config["model"]["raw_model"]
    ...
    if validation_method == "GROUPKFOLD":
        ...
        groupkfold_params, metadata, artifact_path = load_groupkfold_loso_aggregate(config, "raw")
    ...
    for fold_idx, split in enumerate(splits, start=1):
        ...
        write_hyperparameter_manifest(
            results_dir, "raw_eegnetlike", validation_method, fold_hyperparameters, groupkfold_aggregate
        )
