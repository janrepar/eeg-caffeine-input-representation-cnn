...
def main():
    ...
    X_raw, y_raw, subjects_raw, conditions_raw = build_raw_dataset_from_alleeg(
        ALLEEG,
        include_conditions=include_conditions,
        exclude_subjects=exclude_subjects,
    )

    X_feat, y_feat, subjects_feat, conditions_feat = build_feature_dataset_from_alleeg(
        ALLEEG,
        fs=fs,
...
def save_dataset_npz(output_path, X, y, subjects, conditions):
